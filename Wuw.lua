    ...
    local function InitializeMainScript()
        ...
        WindUI:AddTheme({ Name = "Quix", Accent = "#4B2D82", Dialog = "#1E142D", Outline = "#46375A", Text = "#E5DCEA", Placeholder = "#A898C2", Background = "#221539", Button = "#8C46FF", Icon = "#A898C2" })
        WindUI:SetTheme("Quix")
        
        local Window = WindUI:CreateWindow({
            Title = gradient("QuixHUB", Color3.fromHex("#8C46FF"), Color3.fromHex("#BE78FF")),
            Icon = "rbxassetid://86271876746664",
            Author = "Premium",
            Size = UDim2.fromOffset(500, 320),
            Folder = "QuixHUB_Config",
            Transparent = false,
            Theme = "Quix",
        ...
        floatingButtonGui.Name = "QuixToggleGUI"
        ...
        floatingButton.Name = "QuixToggle"
        ...
        floatingButton.Image = "rbxassetid://86271876746664"
        ...
        local HubSection = Window:Section({ Title = "Quix Hub", Opened = true })
        ...
        do
            HubTabs.Home:Paragraph({ Title = "Welcome to QuixHUB", Desc = "QuixHUB is a universal script hub designed to provide the best experience across various Roblox games. Enjoy powerful, user-friendly, and consistently updated features.", Image = "rbxassetid://90566677928169", ImageSize = 24, Color = Color3.fromHex("#BE78FF") })
            HubTabs.Home:Section({ Title = "Developer Team" })
            HubTabs.Home:Paragraph({ Title = "Civas", Desc = "Owner", Image = "rbxassetid://86271876746664", ImageSize = 32 })
            HubTabs.Home:Paragraph({ Title = "Gee", Desc = "Owner 2", Image = "rbxassetid://86271876746664", ImageSize = 32 })
            HubTabs.Home:Paragraph({ Title = "Quix", Desc = "Lujeleksi", Image = "rbxassetid://86271876746664", ImageSize = 32 })
            ...
            local DiscordInfo = HubTabs.Home:Paragraph({ Title = "Discord Server", Desc = "Loading...", Image = "rbxassetid://86271876746664", ImageSize = 32 })
            local telegramUsername = "Quixscript"
            local TelegramInfo = HubTabs.Home:Paragraph({ Title = "Telegram Channel", Desc = "Loading...", Image = "rbxassetid://86271876746664", ImageSize = 32 })
            ...
            HubTabs.Home:Paragraph({ Title = "Tiktok", Desc = "tiktok.com/@chadichaa", Image = "tiktok", Color = Color3.fromHex("#FF0000"), Buttons = {{ Title = "Copy Link", Icon = "copy", Variant = "Tertiary", Callback = function() setclipboard("tiktok.com/@chadichaa"); WindUI:Notify({ Title = "Copied!", Content = "Tiktok link copied to clipboard.", Duration = 3 }) end }} })
            HubTabs.Home:Paragraph({ Title = "Community", Desc = "https://chat.whatsapp.com/F23EhYxHS1WEZwKJ43vL3k?mode=ems_copy_t"..discordInviteCode, Image = "message-square", Color = Color3.fromHex("#5865F2"), Buttons = {{ Title = "Copy Link", Icon = "copy", Variant = "Tertiary", Callback = function() setclipboard("https://chat.whatsapp.com/F23EhYxHS1WEZwKJ43vL3k?mode=ems_copy_t"..discordInviteCode); WindUI:Notify({ Title = "Copied!", Content = "Community link copied to clipboard.", Duration = 3 }) end }} })
        end
        ...
        do
                ...
                task.spawn(function()
                    while task.wait(5) do
                        ...
                        if eventPart and not eventTPState.isAtEvent then
                            ...
                            eventTPState.platform.Name = "QuixEventPlatform"
            ...
            do
                ...
                if ConfigManager then
                    local myConfig = ConfigManager:CreateConfig("QuixFishItConfig")
                    ...
                    local autoLoadConfigPath = "QuixHUB_Config/Quix_AutoLoad.json"
        ...
        if Window then
            Window:SelectTab(1)
            WindUI:Notify({ Title = "QuixHUB Ready", Content = "All features have been loaded. Enjoy!", Duration = 8, Icon = "check-circle" })
        end
    end
end
